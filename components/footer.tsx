...
export function Footer() {
  return (
    <footer className="dark:bg-[#1f1f1f] border-t-4 border-[var(--border)] bg-[var(--background)] py-12 flex justify-center items-center">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="flex flex-col items-center md:items-start">
            <Link href="/" className="mb-4">
              <div className="flex items-center space-x-2 rounded-md border-2 border-[var(--border)] bg-[var(--background)] px-4 py-2 shadow-[4px_4px_0px_0px_var(--border)]">
                ...
                <span className="font-['Pixelify_Sans'] text-[var(--foreground)]">
                  Pyxis
                </span>
              </div>
            </Link>
          ...
          {/* Quick Links */}
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-xl font-bold text-[var(--foreground)] mb-4 font-['Pixelify_Sans']">
              Quick Links
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="#"
                  className="text-[var(--foreground)] hover:underline font-['Pixelify_Sans']"
                >
                  Products
                </Link>
              </li>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/viraj-ap" target="_blank">
              <Button
                variant="default"
                size="icon"
                className="border-2 border-[var(--border)] shadow-[4px_4px_0px_0px_var(--border)]"
              >
